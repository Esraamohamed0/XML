...
$address = "$country - $city - $region - $buildingNumber - $street";
...
if($_GET["action"] === "insert"){
  ...
  $country = $dom->createElement("country", $addressArray[0]);
  $city = $dom->createElement("city",$addressArray[1]);
  $region = $dom->createElement("region",$addressArray[2]);
  $buildingNumber = $dom->createElement("buildingNumber",$addressArray[3]);
  $street = $dom->createElement("street",$addressArray[4]);
...
if($_GET["action"] === "update"){
  ...
  $country = $address->childNodes[0]->nodeValue = $addressArray[0];
  $city = $address->childNodes[1]->nodeValue = $addressArray[1];
  $region = $address->childNodes[2]->nodeValue = $addressArray[2];
  $buildingNumber = $address->childNodes[3]->nodeValue = $addressArray[3];
  $street = $address->childNodes[4]->nodeValue = $addressArray[4];
